...
*/
    ...
    rootNode = insertNode(rootNode, 16, "Adam");
    rootNode = insertNode(rootNode, 12, "Brano");
    rootNode = insertNode(rootNode, 1, "Cernak");
    rootNode = insertNode(rootNode, 21, "Dano");
    rootNode = insertNode(rootNode, 3, "Erik");
    rootNode = insertNode(rootNode, 15, "Fero");
    rootNode = insertNode(rootNode, 4, "Gero");
    rootNode = insertNode(rootNode, 5, "Hala");
    rootNode = insertNode(rootNode, 6, "Ivan");
    rootNode = insertNode(rootNode, 7, "Jaro");
    rootNode = insertNode(rootNode, 20, "Karok");
    rootNode = insertNode(rootNode, 24, "Lubo");
    rootNode = insertNode(rootNode, 7,"Marek");
    rootNode = insertNode(rootNode, 13, "Nos");
    rootNode = insertNode(rootNode, 2,"Opica");
